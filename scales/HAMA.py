...
# 描述性语句列表从Excel文件中读取
file_path = 'C:\\Users\\14542\\Desktop\\MProject\\scales\\HAMD.xlsx'
...
def generate_responses(spark, descriptions):
    ...
    rating_instruction = "请你扮演一个心理状况焦虑的大学生对每个描述回复对应的数字以表明你症状出现的程度，0：无症状、1：轻微、2：中等、3：较重、4：严重。你只需要回复一个数字。"
...
if __name__ == '__main__':
    ...
    output_file = 'C:\\Users\\14542\\Desktop\\MProject\\scales\\jiaolv_HAMD_responses.xlsx'
