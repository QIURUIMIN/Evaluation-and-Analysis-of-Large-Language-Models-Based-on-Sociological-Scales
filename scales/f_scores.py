...
folder_path = 'C:/Users/14542/Desktop/MProject/scales/'

# Process all Excel files in the folder matching the pattern
file_pattern = folder_path + '*_Extracted_Values.xlsx'
